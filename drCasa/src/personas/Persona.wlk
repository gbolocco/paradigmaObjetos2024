class Persona {
  ...
  method donarA(otraPersona, cantidadADonar) { // donarA en vez recibirDe porque la persona sabe cuanta sangre tiene y de que tipo
    if (self.puedeDonar(otraPersona)) {
